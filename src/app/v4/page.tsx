  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="mt-1 w-full rounded-md border border-slate-300 bg-white px-3 py-2 font-mono outline-none focus:border-teal-600 focus:ring-2 focus:ring-teal-100"
      />
    </label>
  );
}
